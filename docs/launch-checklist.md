...
`thebeautyof.earth` is **verified**. All eight templates were sent through
...
- **Check the announcement renders in a real client** —
  `scripts/smoke-email.mts` sends all eight templates to an address you name.
...
- **Email** — all eight templates delivered through Resend to a real inbox.
